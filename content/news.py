...
_FILTER_PROMPT = """You filter a news feed for EDI Labs, a consultancy that builds AI for European public services — defense, health, public management and mobility, financial services, and sector trends in AI and energy.
    ...
    try:
        resp = httpx.post(
            ...
            headers={
                ...
                "HTTP-Referer": "https://edilabs.tech",
                "X-Title": "EDI Labs News Filter",
            },
            json=payload,
            timeout=20.0,
        )
